...
public class YTERPDataDao {
    ...
    @Autowired
    ICStockBillEntry3Mapper icStockBillEntry3Mapper;
...
//                t_item.setFnumber(StringUtil.getStr(resultSet.getString("prdt_type")));
    ...
    public boolean getEcs_erp_sys_prdts(String startTime, String endTime) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                t_icItemCore3Mapper.insert(t_icItemCore);
                ...
                t_icItemBase3Mapper.insert(t_icItemBase);
                ...
                t_icItemMaterial3Mapper.insert(t_iCItemMaterial);
                ...
                t_icItemPlan3Mapper.insert(t_icItemPlan);
                ...
                t_iCItemDesign3Mapper.insert(t_icItemDesign);
                ...
                t_icItemStandard3Mapper.insert(t_icItemStandard);
                ...
                t_icItemQuality3Mapper.insert(t_icItemQuality);
                ...
                t_icItemCustom3Mapper.insert(t_icItemCustom);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public boolean getEcs_erp_sys_custs(String startTime, String endTime) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                t_Supplier3Mapper.insert(t_supplier);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public boolean getEcs_erp_sal_outs(String startTime, String endTime) {
        ...
        try {
            st = connection.createStatement();
            sql = "select b.id as FInterID,b.prdt_id,b.qty_real,t.* from ecs_erp_stk_head t ";
            sql += "left join ecs_erp_stk_head_details b on t.id = b.parent_id ";
            sql += "where t.bil_status = 5 and (t.branch_id = 3 or t.branch_id = 4) and t.send_date >= '" + startTime + "'";
            if (!StringUtils.isEmpty(endTime)) {
                sql += "and t.send_date <= '" + endTime + "' ";
            }
            resultSet = sshConnection.runSql(sql, st);
            while (resultSet.next()) {
                ...
                icStockBillEntry.setFqty(new BigDecimal(StringUtil.strToNum(resultSet.getString("qty_real"))));
                icStockBillEntry.setFprice(new BigDecimal(StringUtil.strToNum(resultSet.getString("adopt_amt"))));
                icStockBillEntry.setFbatchno("");
                icStockBillEntry.setFamount(new BigDecimal(StringUtil.strToNum(resultSet.getString("adopt_amt"))));
                ...
                icStockBillEntry.setFauxprice(new BigDecimal(StringUtil.strToNum(resultSet.getString("adopt_amt"))));
                ...
                icStockBillEntry.setFconsignprice(new BigDecimal(StringUtil.strToNum(resultSet.getString("adopt_amt"))));
                icStockBillEntry.setFconsignamount(new BigDecimal(StringUtil.strToNum(resultSet.getString("adopt_amt"))));
                ...
                icStockBillEntry3Mapper.insert(icStockBillEntry);
                ...
                icstockbill.setFsupplyid(Integer.parseInt("20000" + StringUtil.strToNum(resultSet.getString("cust_id"))));//销售：对应客户
                ...
                icstockbill3Mapper.insert(icstockbill);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public boolean getEcs_erp_pur_ins(String startTime, String endTime) {
        ...
        try {
            ...
            sql += "where t.bil_status = 4 and (t.branch_id = 3 or t.branch_id = 4) and t.chk_date >= '" + startTime + "'";
            if (!StringUtils.isEmpty(endTime)) {
    ...
    public boolean getEcs_erp_sys_sites(String startTime, String endTime) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                t_Organization3Mapper.insert(t_organization);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
