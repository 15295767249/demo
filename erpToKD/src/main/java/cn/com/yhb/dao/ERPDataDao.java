...
//                t_item.setFnumber(StringUtil.getStr(resultSet.getString("prdt_type")));
    ...
    public boolean getEcs_erp_sal_outs(String startTime, String endTime) {
        ...
        try {
            st = connection.createStatement();
//            sql = "select b.id as FInterID,b.prdt_id,b.qty,b.amt_tax,t.* from ecs_erp_sal_out t ";
//            sql += "left join ecs_erp_sal_out_details b on t.id = b.parent_id ";
            sql = "select t.* from ecs_erp_orders_details t ";
            ...
            resultSet = sshConnection.runSql(sql, st);
            while (resultSet.next()) {
                if (Integer.parseInt(StringUtil.strToNum(resultSet.getString("wh_id"))) >= 1) {
                    ICStockBillEntry icStockBillEntry = new ICStockBillEntry();
                    icStockBillEntry.setFbrno("0");
                    icStockBillEntry.setFinterid(Integer.parseInt("7" + StringUtil.strToNum(resultSet.getString("id"))));
                    ...
                    icStockBillEntry.setFprice(new BigDecimal(StringUtil.strToNum(resultSet.getString("up"))));
                    icStockBillEntry.setFbatchno("");
                    icStockBillEntry.setFamount(new BigDecimal(StringUtil.strToNum(resultSet.getString("up"))));
                    ...
                    icStockBillEntry.setFauxprice(new BigDecimal(StringUtil.strToNum(resultSet.getString("up"))));
                    ...
                    icStockBillEntry.setFconsignprice(new BigDecimal(StringUtil.strToNum(resultSet.getString("up"))));
                    icStockBillEntry.setFconsignamount(new BigDecimal(StringUtil.strToNum(resultSet.getString("up"))));
                    ...
                    icStockBillEntry.setFdcstockid(Integer.parseInt("30000" + StringUtil.strToNum(resultSet.getString("wh_id"))));
                    ...
                    icstockbill.setFinterid(Integer.parseInt(StringUtil.strToNum("7" + resultSet.getString("id"))));
                    icstockbill.setFtrantype((short) 21);
                    icstockbill.setFdate(DateUtil.StringToDate1(resultSet.getString("order_date")));
                    icstockbill.setFbillno(StringUtil.getStr(resultSet.getString("prdt_code")));
                    icstockbill.setFuse("");
                    ...
                    icstockbill.setFbillerid(16394);
    ...
    public boolean getEcs_erp_afs_results(String startTime, String endTime) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                icStockBillEntry.setFstdcurrenthookamount(new BigDecimal(0));
                icStockBillEntry.setFscstockid(0);
                icStockBillEntry.setFdcstockid(Integer.parseInt("30000" + StringUtil.strToNum(resultSet.getString("back_wh"))));
                icStockBillEntry.setFperioddate(null);
                icStockBillEntry.setFcostobjgroupid(0);
                icStockBillEntry.setFcostobjid(0);
                icStockBillEntry.setFdetailid(null);
                ...
                icstockbill.setFdcstockid(Integer.parseInt("30000" + StringUtil.strToNum(resultSet.getString("back_wh"))));
    ...
    public boolean getEcs_erp_stk_moves(String startTime, String endTime) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                icStockBillEntry.setFstdcurrenthookamount(new BigDecimal(0));
                icStockBillEntry.setFscstockid(0);
                icStockBillEntry.setFdcstockid(Integer.parseInt("30000" + StringUtil.strToNum(resultSet.getString("wh_id_in"))));
                icStockBillEntry.setFperioddate(null);
                icStockBillEntry.setFcostobjgroupid(0);
                icStockBillEntry.setFcostobjid(0);
                icStockBillEntry.setFdetailid(null);
    ...
    public boolean getEcs_erp_pur_ins(String startTime, String endTime) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                icstockbill.setFuse("");
                icstockbill.setFnote(StringUtil.getStr(resultSet.getString("memo_info")));
                icstockbill.setFdcstockid(Integer.parseInt("30000" + StringUtil.strToNum(resultSet.getString("wh_id"))));
                icstockbill.setFscstockid(0);
                icstockbill.setFdeptid(0);
                icstockbill.setFempid(0);
