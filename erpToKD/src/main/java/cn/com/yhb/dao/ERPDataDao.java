...
//                t_item.setFnumber(StringUtil.getStr(resultSet.getString("prdt_type")));
    ...
    public boolean getEcs_erp_sal_outs(String startTime, String endTime) {
        ...
        try {
            st = connection.createStatement();
            sql = "select b.id as FInterID,b.prdt_id,t.* from ecs_erp_sal_out t ";
            ...
            while (resultSet.next()) {
                ...
                icStockBillEntry.setFinterid(Integer.parseInt(StringUtil.strToNum("70000" + resultSet.getString("FInterID"))));
                ...
                icStockBillEntry.setFqty(new BigDecimal(0));
                ...
                icStockBillEntry.setFauxqty(new BigDecimal(0));
                icStockBillEntry.setFauxqtymust(new BigDecimal(0));
                ...
                icstockbill.setFinterid(Integer.parseInt(StringUtil.strToNum("70000" + resultSet.getString("FInterID"))));
    ...
    public boolean getEcs_erp_afs_results(String startTime, String endTime) {
        ...
        try {
            st = connection.createStatement();
            sql = "select b.id as FInterID,b.prdt_id,t.*,r.site_id from ecs_erp_afs_result t ";
    ...
    public boolean getEcs_erp_stk_moves(String startTime, String endTime) {
        ...
        try {
            st = connection.createStatement();
            sql = "select b.id as FInterID,b.prdt_id,t.* from ecs_erp_stk_move t ";
    ...
    public boolean getEcs_erp_pur_ins(String startTime, String endTime) {
        ...
        try {
            st = connection.createStatement();
            sql = "select b.id as FInterID,b.prdt_id,t.* from ecs_erp_pur_in t ";
    ...
    public boolean getEcs_erp_pur_backs(String startTime, String endTime) {
        ...
        try {
            st = connection.createStatement();
            sql = "select b.id as FInterID,b.prdt_id,t.* from ecs_erp_pur_back t ";
